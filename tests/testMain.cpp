...
int main()
{
    PTP_LOG_CUSTOM("TEST", ptp::log::LogLevel::Info, "This is a Info message" << " with a stream" << " and a number: " << 42);
    PTP_LOG_INFO("This is a Info message" << " with a stream" << " and a number: " << 42);
    PTP_LOG_DEBUG("This is just a simple message.");
